...
parser.add_argument('--method', type=str, default='LCAFI')
...
from methods.LCAFI import LCAFI
...
mat_file_path = os.path.join(r'C:\Users\Administrator\Desktop\LCAFI\dataset', f'{args.dataset}.mat')
...
def get_model_by_name(method, x_train, y_train, args, label_corr):
    if method == 'LCAFI':
        return LCAFI(num_features=x_train.shape[1], num_labels=y_train.shape[1],
